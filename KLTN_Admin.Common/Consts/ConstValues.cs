namespace KLTN_Admin.Common.Consts
{
    public static class ConstValues
    {
        public static class LoaiXe
        {
            public const string XeGiuongNam = "xe_giuong";

            public const string XeThuong = "xe_thuong";
        }

        public static class KieuXepLoaiDanhSo
        {
            public const string TraiSangPhai = "trai_qua_phai";

            public const string PhaiSangTrai = "phai_qua_trai";

            public const string DuoiLenTren = "duoi_len_tren";
